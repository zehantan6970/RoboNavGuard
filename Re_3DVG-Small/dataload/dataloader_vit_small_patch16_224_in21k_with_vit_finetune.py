...
model = ViTModel.from_pretrained("WinKawaks/vit-small-patch16-224").to(device)
vit_file="/media/light/light_t2/PROJECTS/D3VG_large/vit/vit_small_for_datasets_train&val&test/pytorch_vit_19.pt"
model.load_state_dict(torch.load(vit_file))
model.eval()
